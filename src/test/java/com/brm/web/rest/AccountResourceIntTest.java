...
public class AccountResourceIntTest {
    ...
    public void testRegisterValid() throws Exception {
        ManagedUser validUser = new ManagedUser(
            null,                   // id
            "joe",                  // login
            "password",             // password
            "Joe",                  // firstName
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ManagedUser invalidUser = new ManagedUser(
            null,                   // id
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        ManagedUser duplicatedUser = new ManagedUser(validUser.getId(), validUser.getLogin(), validUser.getPassword(), validUser.getLogin(), validUser.getLastName(),
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        ManagedUser duplicatedUser = new ManagedUser(validUser.getId(), "johnjr", validUser.getPassword(), validUser.getLogin(), validUser.getLastName(),
