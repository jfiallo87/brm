package com.brm.web.rest.util;

import com.brm.domain.Error;
import com.brm.domain.ParameterizedError;
import com.brm.domain.util.CustomParameterizedException;
import com.brm.domain.util.ErrorConstants;
...
public class ExceptionTranslator {
    ...
    @ResponseBody
    public Error processConcurencyError(ConcurrencyFailureException ex) {
    ...
    @ResponseBody
    public Error processAccessDeniedExcpetion(AccessDeniedException e) {
    ...
    public ResponseEntity<Error> processRuntimeException(Exception ex) throws Exception {
        ...
        if (responseStatus != null) {
            ...
            errorDTO = new Error("error." + responseStatus.value().value(), responseStatus.reason());
        } else {
            builder = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR);
            errorDTO = new Error(ErrorConstants.ERR_INTERNAL_SERVER_ERROR, "Internal server error");
        }
