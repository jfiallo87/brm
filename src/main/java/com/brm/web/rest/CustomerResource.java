...
import com.brm.repository.CustomerRepository;
...
public class CustomerResource {
    ...
    public ResponseEntity<Customer> createCustomer(@Valid @RequestBody Customer customer) throws URISyntaxException {
        ...
        if (customer.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtils.createFailureAlert("customer", "idexists", "A new customer cannot already have an ID")).body(null);
        }
        Customer result = customerRepository.save(customer);
        return ResponseEntity.created(new URI("/api/customers/" + result.getId()))
            .headers(HeaderUtils.createEntityCreationAlert("customer", result.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Customer> updateCustomer(@Valid @RequestBody Customer customer) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtils.createEntityUpdateAlert("customer", customer.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<Customer>> getAllCustomers(Pageable pageable)
        ...
        HttpHeaders headers = PaginationUtils.generatePaginationHttpHeaders(page, "/api/customers");
    ...
    public ResponseEntity<Void> deleteCustomer(@PathVariable Long id) {
        ...
        return ResponseEntity.ok().headers(HeaderUtils.createEntityDeletionAlert("customer", id.toString())).build();
    }
